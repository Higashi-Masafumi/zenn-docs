...
以下は`IUserRepository`を実際に実装してもらった例です。

```python:i_user_repository.py
...
:::details Notion APIを使った具体実装
```python:notion_user_repository.py
